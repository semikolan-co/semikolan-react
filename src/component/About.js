...
function About(props) {
  ...
  <div className="aboutdiv">
    <div data-aos="fade-right" data-aos-duration={500}>
      <p>{props.content ? props.content : `Hello! I'm Harsh, a Pseudo Web Developer. I am a Full Stack Web Developer who used to Code in different languages like <a href>HTML</a> , CSS, JavaScript, PHP, MySQL and there different Frameworks like jQuery, Bootstrap.css, Animate.css etc. As Well as I sometimes use
